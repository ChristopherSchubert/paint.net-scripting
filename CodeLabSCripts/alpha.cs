...
#region UICode
IntSliderControl Alpha = 255; // [0,255,4] Alpha
CheckboxControl Amount2 = false; // [0,1] Show Half
CheckboxControl Amount3 = false; // [0,1] Show Original
CheckboxControl Amount4 = false; // [0,1] Retain Transparency
ReseedButtonControl Amount5 = 0; // [255] Reprocess
#endregion
...
private void AssignUIValues()
{
    ...
    showOriginal.Value = Amount3;
    retainTransparency.Value = Amount4;
    reprocess.Value = (int)Amount5;
}
