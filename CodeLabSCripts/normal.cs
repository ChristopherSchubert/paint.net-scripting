...
{
    HsvColor[,] hsvGrid = new HsvColor[3,3];
    ...
    for (int y = selection.Top; y < selection.Bottom; y++)
    {
        for (int x = selection.Left; x < selection.Right; x++)
        {
            ...
            hsvGrid[1,1] = HsvColor.FromColor(src[x  ,y  ].ToColor());



            if (x > 0           && y < src.Height-1) { hsvGrid[0,0] = HsvColor.FromColor(src[x-1,y+1].ToColor()); } else { hsvGrid[0,0] = HsvColor.FromColor(ColorBgra.Transparent.ToColor()); }
            if (                   y < src.Height-1) { hsvGrid[0,1] = HsvColor.FromColor(src[x  ,y+1].ToColor()); } else { hsvGrid[0,1] = HsvColor.FromColor(ColorBgra.Transparent.ToColor()); }
            if (x < src.Width-1 && y < src.Height-1) { hsvGrid[0,2] = HsvColor.FromColor(src[x+1,y+1].ToColor()); } else { hsvGrid[0,2] = HsvColor.FromColor(ColorBgra.Transparent.ToColor()); }
            if (x > 0                              ) { hsvGrid[1,0] = HsvColor.FromColor(src[x-1,y  ].ToColor()); } else { hsvGrid[1,0] = HsvColor.FromColor(ColorBgra.Transparent.ToColor()); }
            if (x < src.Width-1                    ) { hsvGrid[1,2] = HsvColor.FromColor(src[x+1,y  ].ToColor()); } else { hsvGrid[1,2] = HsvColor.FromColor(ColorBgra.Transparent.ToColor()); }
            if (x > 0           && y > 0)            { hsvGrid[2,0] = HsvColor.FromColor(src[x-1,y-1].ToColor()); } else { hsvGrid[2,0] = HsvColor.FromColor(ColorBgra.Transparent.ToColor()); }
            if (                   y > 0)            { hsvGrid[2,1] = HsvColor.FromColor(src[x  ,y-1].ToColor()); } else { hsvGrid[2,1] = HsvColor.FromColor(ColorBgra.Transparent.ToColor()); }
            if (x < src.Width-1 && y > 0)            { hsvGrid[2,2] = HsvColor.FromColor(src[x+1,y-1].ToColor()); } else { hsvGrid[2,2] = HsvColor.FromColor(ColorBgra.Transparent.ToColor()); }
