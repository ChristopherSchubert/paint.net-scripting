...
CheckboxControl Amount4 = false; // [0,1] Show Palette
...
unsafe void PreRenderInternal(Surface src)
{
    ...
    palette.InitializePalette(
        ...
        paletteSplit, 
        colorSampling, 
        colorFrequencyEqualization, 
        narrowRangeFromBottomBy, 
        narrowRangeFromTopBy, 
        colorPaletteLength, 
...
private void AssignUIValues()
{
    ...
    showPalette.Value = Amount4;
    preBlur.Value = Amount5;
    colorSampling.Value = Amount6;
    narrowRangeFromBottomBy.Value = Amount7;
    narrowRangeFromTopBy.Value = Amount8;
    colorFrequencyEqualization.Value = Amount9;
...
TrackingProperty<int> colorSampling = new TrackingProperty<int>();
TrackingProperty<int> narrowRangeFromBottomBy = new TrackingProperty<int>();
TrackingProperty<int> narrowRangeFromTopBy = new TrackingProperty<int>();
