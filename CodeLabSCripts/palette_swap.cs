...
IntSliderControl Amount5 = 3; // [2,8] Color Palette Length
IntSliderControl Amount6 = 6; // [1,20] Color Palette Hues
#endregion
...
unsafe void PreRenderInternal(Surface src)
{
    ...
    palette.InitializePalette(img, 1, 1, 1, 254, paletteLength, paletteHues);
...
private void AssignUIValues()
{
    ...
    paletteLength.Value = (int)Amount5;
    paletteHues.Value = (int)Amount6;
}
...
TrackingProperty<int> paletteLength = new TrackingProperty<int>();
TrackingProperty<int> paletteHues = new TrackingProperty<int>();
