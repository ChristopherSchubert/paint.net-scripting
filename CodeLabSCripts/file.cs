// Name:Transparent Black to Transparent
// Submenu:Chris_Batch
// Author:
// Title:Transparent Black to Transparent
// Version:
// Desc:
// Keywords:
// URL:
...
CheckboxControl Amount2 = false; // [0,1] Process
#endregion
    ...
    foreach(var filePath in Directory.GetFiles(directory))
    {
        ...
        foreach(BitmapLayer layer in document.Layers)
        {
            for(var y = 0; y < layer.Height; y++)
            {
                ...
                {
                    if (layer.Surface[x,y] == ColorBgra.TransparentBlack)
                    {
                        layer.Surface[x,y] = ColorBgra.Transparent;
                    }
                }
            }
        }
