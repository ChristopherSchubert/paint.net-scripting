...
IntSliderControl Amount5 = 0; // [0,360,1] Hue 
IntSliderControl Amount6 = 5; // [0,100,1] Minimum Saturation
IntSliderControl Amount7 = 95; // [0,100,1] Maximum Saturation 
IntSliderControl Amount8 = 5; // [0,100,1] Minimum Value 
IntSliderControl Amount9 = 95; // [0,100,1] Maximum Value 
IntSliderControl Amount10 = 30; // [0,200,5] Minimum SV Sum
IntSliderControl Amount11 = 150; // [0,200,5] Maximum SV Sum
#endregion
...
{ 
    ...
    var minimumFunctionalSv = Math.Min(minimumSat, minimumVal);
    var maximumFunctionalSv = maximumSat + maximumVal;
    var svSumRange = Int32Util.Clamp(maximumSVSum - minimumSVSum, minimumFunctionalSv, maximumSVSum);

    for(var y = 0; y < src.Height; y++)
    for(var x = 0; x < src.Width; x++)
    {
        var timeX = (float)x / (float)src.Width;
        var timeY = (float)y / (float)src.Height;

        var sat = 0;
        var val = 0;
        
        var allowedSum = minimumFunctionalSv + (int)(svSumRange * timeY);

        sat = (int)(allowedSum * .5f);
        val = allowedSum - sat;
        ...
        working[x,y] = ColorBgra.FromColor(color.ToColor());
...
private void AssignUIValues()
{
    ...
    hue.Value = (int)Amount5;
    minimumSat.Value = (int)Amount6;
    maximumSat.Value = (int)Amount7;
    minimumVal.Value = (int)Amount8;
    maximumVal.Value = (int)Amount9;
    minimumSVSum.Value = (int)Amount10;
    maximumSVSum.Value = (int)Amount11;
}
...
TrackingProperty<int> hue = new TrackingProperty<int>();
TrackingProperty<int> minimumSat = new TrackingProperty<int>();
TrackingProperty<int> maximumSat = new TrackingProperty<int>();
TrackingProperty<int> minimumVal = new TrackingProperty<int>();
TrackingProperty<int> maximumVal = new TrackingProperty<int>();
TrackingProperty<int> minimumSVSum = new TrackingProperty<int>();
TrackingProperty<int> maximumSVSum = new TrackingProperty<int>();
