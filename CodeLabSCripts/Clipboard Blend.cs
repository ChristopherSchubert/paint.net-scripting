// Name:Paste Texture Blend
// Submenu:Chris
// Author:
// Title:Paste Texture Blend
// Version:
// Desc:
// Keywords:
// URL:
...
ListBoxControl Amount5 = 23; // Blend Mode 1|Normal|Additive|Average|Blue|Color|ColorBurn|ColorDodge|Cyan|Darken|Difference|Divide|Exclusion|Glow|GrainExtract|GrainMerge|Green|HardLight|HardMix|Hue|Lighten|LinearBurn|LinearDodge|LinearLight|Luminosity|Magenta|Multiply|Negation|Overlay|Phoenix|PinLight|Red|Reflect|Saturation|Screen|SignedDifference|SoftLight|Stamp|VividLight|Yellow
IntSliderControl Amount6 = 255; // [0,255,4] Opacity 1
CheckboxControl Amount7 = false; // [0,1] Invert Order

ListBoxControl Amount8 = 0; // Blend Mode 2|Normal|Additive|Average|Blue|Color|ColorBurn|ColorDodge|Cyan|Darken|Difference|Divide|Exclusion|Glow|GrainExtract|GrainMerge|Green|HardLight|HardMix|Hue|Lighten|LinearBurn|LinearDodge|LinearLight|Luminosity|Magenta|Multiply|Negation|Overlay|Phoenix|PinLight|Red|Reflect|Saturation|Screen|SignedDifference|SoftLight|Stamp|VividLight|Yellow
IntSliderControl Amount9 = 0; // [0,255,4] Opacity 2
CheckboxControl Amount10 = false; // [0,1] Invert Order

ListBoxControl Amount11 = 0; // Blend Mode 3|Normal|Additive|Average|Blue|Color|ColorBurn|ColorDodge|Cyan|Darken|Difference|Divide|Exclusion|Glow|GrainExtract|GrainMerge|Green|HardLight|HardMix|Hue|Lighten|LinearBurn|LinearDodge|LinearLight|Luminosity|Magenta|Multiply|Negation|Overlay|Phoenix|PinLight|Red|Reflect|Saturation|Screen|SignedDifference|SoftLight|Stamp|VividLight|Yellow
IntSliderControl Amount12 = 0; // [0,255,4] Opacity 3
CheckboxControl Amount13 = false; // [0,1] Invert Order

ListBoxControl Amount14 = 0; // Blend Mode 4|Normal|Additive|Average|Blue|Color|ColorBurn|ColorDodge|Cyan|Darken|Difference|Divide|Exclusion|Glow|GrainExtract|GrainMerge|Green|HardLight|HardMix|Hue|Lighten|LinearBurn|LinearDodge|LinearLight|Luminosity|Magenta|Multiply|Negation|Overlay|Phoenix|PinLight|Red|Reflect|Saturation|Screen|SignedDifference|SoftLight|Stamp|VividLight|Yellow
IntSliderControl Amount15 = 0; // [0,255,4] Opacity 4
CheckboxControl Amount16 = false; // [0,1] Invert Order
...
unsafe void RenderInternal(Surface dst, Surface src)
{
    ...
    if (img == null)
    {
        dst.Clear(ColorBgra.Magenta);
        return;
    }
   
    if (opacity1 > 0)
    {
        BlendSurfaces(working2, inversion1 ? img : working, inversion1 ? working : img, byte.MaxValue, (BlendModes)blendMode1.Value);
        BlendSurfaces(working, working, working2, opacity1, BlendModes.Normal);
    }
        
    if (opacity2 > 0)
    {
        BlendSurfaces(working2, inversion2 ? img : working, inversion2 ? working : img, byte.MaxValue, (BlendModes)blendMode2.Value);
        BlendSurfaces(working, working, working2, opacity2, BlendModes.Normal);
    }    

    if (opacity3 > 0)
    {
        BlendSurfaces(working2, inversion3 ? img : working, inversion3 ? working : img, byte.MaxValue, (BlendModes)blendMode3.Value);
        BlendSurfaces(working, working, working2, opacity2, BlendModes.Normal);
    }    

    if (opacity4 > 0)
    {
        BlendSurfaces(working2, inversion4 ? img : working, inversion4 ? working : img, byte.MaxValue, (BlendModes)blendMode4.Value);
        BlendSurfaces(working, working, working2, opacity2, BlendModes.Normal);
    }
...
private void AssignUIValues()
{
    ...
    blendMode1.Value = (int)Amount5;
    opacity1.Value = (int)Amount6;
    inversion1.Value = Amount7;

    blendMode2.Value = (int)Amount8;
    opacity2.Value = (int)Amount9;
    inversion2.Value = Amount10;

    blendMode3.Value = (int)Amount11;
    opacity3.Value = (int)Amount12;
    inversion3.Value = Amount13;

    blendMode4.Value = (int)Amount14;
    opacity4.Value = (int)Amount15;
    inversion4.Value = Amount16;
}
...
TrackingProperty<int> blendMode1 = new TrackingProperty<int>();
TrackingProperty<int> opacity1 = new TrackingProperty<int>();
TrackingProperty<bool> inversion1 = new TrackingProperty<bool>();

TrackingProperty<int> blendMode2 = new TrackingProperty<int>();
TrackingProperty<int> opacity2 = new TrackingProperty<int>();
TrackingProperty<bool> inversion2 = new TrackingProperty<bool>();

TrackingProperty<int> blendMode3 = new TrackingProperty<int>();
TrackingProperty<int> opacity3 = new TrackingProperty<int>();
TrackingProperty<bool> inversion3 = new TrackingProperty<bool>();

TrackingProperty<int> blendMode4 = new TrackingProperty<int>();
TrackingProperty<int> opacity4 = new TrackingProperty<int>();
TrackingProperty<bool> inversion4 = new TrackingProperty<bool>();
...
private void BlendSurfaces(Surface destination, Surface leftHand, Surface rightHand, int opacity, params BlendModes[] args)
{
    BlendSurfaces(destination, leftHand, rightHand, (byte)opacity, args);
}
    ...
    try
    {
        ...
        for (var y = 0; y < destination.Height; y++)
        {
            for (var x = 0; x < destination.Width; x++)
            {
                ...
                var rhsX = x % rightHand.Width;
                var rhsY = y % rightHand.Height;

                var lhs = leftHand[x, y];
                var rhs = rightHand[rhsX, rhsY];
                rhs.A = opacity;
